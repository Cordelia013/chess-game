    ...
    <section className="relative w-full h-screen pb-6 px-4 flex flex-col">
      ...
      <div className="flex flex-col flex-grow h-full">
        ...
        <div className="flex flex-1" style={{ flexBasis: "80%", minHeight: 0 }}>
          <div className="bg-amber-400" style={{ width: "32vw" }}>
            {/* Première row, première colonne */}
          </div>
            <div className="flex-1 bg-green-400 border-l-2 border-black">
        ...
        <div className="flex flex-1 " style={{ flexBasis: "40%", minHeight: 0 }}>
          ...
          <div className="bg-blue-400" style={{ width: "32vw" }}>
            ...
            <div className="flex-1 flex  border-b-1 border-black">
                ...
                <p className="bg-pink-200" style={{ width: "66.5%" }}>Tournois réguliers</p>
            </div>
            <div className="flex-1 flex bg-purple-400 border-b-1 border-black">
              <p className="font-bold" style={{ width: "33.5%" }}>02</p>
              <p style={{ width: "66.5%" }}>Membres qui aiment se creuser les méninges</p> 
            </div>

            <div className="flex-1 flex bg-yellow-400 border-b-1 border-black">
              <p className="font-bold" style={{ width: "33.5%" }}>03</p>
              <p style={{ width: "66.5%" }}>Conseils et parties commentées</p>
            </div>
            <div className="flex-1 flex bg-red-400">
              <p className="font-bold" style={{ width: "33.5%" }}>04</p>
              <p className="bg-red-200" style={{ width: "66.5%" }}>Communauté amicale</p>
            </div>
            </div>
        </div>
      </div>
