      ...
      <div className="flex flex-col h-full">
        ...
        <div className="grid grid-cols-12 gap-2 md:gap-4 my-2 md:my-4 h-58 sm:h-70 md:h-80 lg:h-92 xl:h-104 relative">
          ...
          <div className="col-span-12 sm:col-start-1 sm:col-span-8 md:col-start-2 lg:col-start-3 md:col-span-8 lg:col-span-6 flex items-center absolute inset-0 pointer-events-none">
            <h2 className="text-[1rem] sm:text-[4.375rem] md:text-[3.125rem] lg:text-[4.375rem] xl:text-[4.375rem] font-bold text-white px-2 sm:px-3 md:px-4 mix-blend-difference z-20 leading-tight">
        ...
        <div className="pb-2 md:pb-4 mb-1 md:mb-2">
          ...
          <div className="grid grid-cols-1  sm:grid-cols-6 md:grid-cols-12 gap-2 md:gap-4 mt-3 md:mt-6">
            <div className=" col-span-6 col-start-2  sm:col-span-10 sm:col-start-2 md:col-span-12 md:col-start-5 text-left px-2 md:px-0">
